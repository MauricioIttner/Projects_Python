...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_191_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula191_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula191_descompactado'
...
def criar_arquivos(qtd: int, zip_dir: Path):
    for i in range(qtd):
        texto = 'arquivo_%s' % i
        with open(zip_dir / f'{texto}.html', 'w') as arquivo:
            arquivo.write(texto)
